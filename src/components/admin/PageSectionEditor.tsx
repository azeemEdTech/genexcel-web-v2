...
const sectionFields: Record<string, { label: string; description: string; fields: FieldDef[] }> = {
  ...
  features: {
    ...
    fields: [
      ...
      { key: 'color', label: 'Gradient Color', type: 'text', placeholder: 'from-secondary-500 to-accent-500', help: 'Tailwind gradient classes' },
  ...
  pricing: {
    ...
    fields: [
      { key: 'name', label: 'Plan Name', type: 'text', placeholder: 'Pro' },
      { key: 'description', label: 'Short Description', type: 'text', placeholder: "Everything in Basic, plus your child's genetic report" },
